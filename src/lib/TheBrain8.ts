...
export class TheBrain8 {
    ...
    public constructor(props?: TheBrain8) {
        ...
        if (props) {
        	...
        	this.brainData = (props.brainData) ? new BrainData(props.brainData): undefined;
        	this.source = (props.source) ? new Source(props.source): undefined;
        	this.attributes = props.attributes?.map(o => new Attribute(o));
        	this.attribute = (props.attribute) ? new Attribute(props.attribute): undefined;
        	...
        	this.attributeDatas = props.attributeDatas?.map(o => new AttributeData(o));
        	this.attributeData = (props.attributeData) ? new AttributeData(props.attributeData): undefined;
        	...
        	this.entryObject = (props.entryObject) ? new EntryObject(props.entryObject): undefined;
        	this.attachments = props.attachments?.map(o => new Attachment(o));
        	this.attachment = (props.attachment) ? new Attachment(props.attachment): undefined;
